---
description: >-
  A not on using json in jsx. If your extension run along side other extensions
  that require a json library then you won't notice this as a problem, but
  otherwise you'd need to add your own.
---
